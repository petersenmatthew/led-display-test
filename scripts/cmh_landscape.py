#!/usr/bin/env python3
"""Draw the 64x32 Claudette Millar Hall landscape on an RGB LED matrix.

The color spans below are a lossless translation of assets/cmh_32x64.png.
They avoid the embedded image decode path so the Raspberry Pi only needs
rgbmatrix and this one script.
"""
