...
The CMH pixel data below is embedded from scripts/cmh_landscape.py so this
file can run directly in the browser preview at index.html. Weather scenes use
the same editable landscape layers, then add scene-specific effects.
"""
...
def main():
    ...
    print("Cycling standalone CMH weather scenes. Press Stop or Ctrl+C to stop.")
    try:
        while True:
            canvas.Clear()
