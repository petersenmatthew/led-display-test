#!/usr/bin/env python3
"""Shared CMH weather scene renderer for 64x32 RGB LED matrices.

This module contains no live weather fetching or infinite loop. Entry scripts
import it so live weather and demos use the same pixel renderer.
"""
