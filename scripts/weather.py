...
# WMO weather codes → (short label, condition, cloud cover).
def classify_condition(weather_code):
    ...
    if c == 3:
        return ("OVC", COND_CLOUDY, CLOUD_OVERCAST)
    if c in (45, 48):
        return ("FOG", COND_CLOUDY, CLOUD_OVERCAST)
    if c in (51, 53, 55, 56, 57):
        return ("DRZ", COND_RAIN, CLOUD_OVERCAST)
...
def main():
    ...
    try:
        while True:
            canvas.Clear()
            draw_condition_scene(canvas, frame, condition, phase, clouds, label)
