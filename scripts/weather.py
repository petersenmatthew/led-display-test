...
TRAIN_DIFF_ENTRIES = (
    ...
    # y = 23
    (5, 23, (53, 123, 207), (154, 149, 145)),
    (6, 23, (53, 123, 207), (154, 149, 145)),
    (7, 23, (53, 123, 207), (154, 149, 145)),
    (8, 23, (53, 123, 207), (154, 149, 145)),
    (9, 23, (53, 123, 208), (154, 149, 145)),
    (10, 23, (53, 123, 208), (154, 149, 145)),
    (11, 23, (53, 123, 208), (154, 149, 145)),
    (12, 23, (53, 123, 208), (154, 149, 145)),
    (13, 23, (53, 123, 208), (154, 149, 145)),
    (14, 23, (53, 124, 207), (154, 149, 145)),
    (15, 23, (53, 122, 206), (154, 149, 145)),
    # y = 24
    (3, 24, (54, 53, 50), (53, 123, 207)),
    (4, 24, (244, 243, 240), (53, 123, 207)),
    (5, 24, (244, 243, 240), (0, 0, 0)),
    (6, 24, (244, 243, 240), (0, 0, 0)),
    (7, 24, (244, 243, 240), (0, 0, 0)),
    (8, 24, (244, 243, 240), (0, 0, 0)),
    (9, 24, (244, 243, 240), (0, 0, 0)),
    (10, 24, (244, 243, 240), (0, 0, 0)),
    (11, 24, (54, 53, 50), (0, 0, 0)),
    (12, 24, (244, 243, 240), (0, 0, 0)),
    (13, 24, (244, 243, 240), (0, 0, 0)),
    (14, 24, (244, 243, 240), (0, 0, 0)),
    (15, 24, (244, 243, 240), (0, 0, 0)),
    (16, 24, (244, 243, 240), (0, 0, 0)),
    (17, 24, (244, 243, 240), (53, 123, 207)),
    (18, 24, (244, 243, 240), (53, 123, 207)),
    (19, 24, (54, 53, 50), (53, 123, 207)),
    (20, 24, (244, 243, 240), (53, 123, 207)),
    # y = 25
    (2, 25, (54, 53, 50), (53, 123, 207)),
    (3, 25, (244, 243, 240), (53, 123, 207)),
    (7, 25, (53, 123, 208), (0, 0, 0)),
    (11, 25, (54, 53, 50), (53, 123, 207)),
    (15, 25, (53, 123, 208), (0, 0, 0)),
    (19, 25, (54, 53, 50), (53, 123, 207)),
    # y = 26
    (1, 26, (54, 53, 50), (53, 123, 207)),
    (2, 26, (54, 53, 50), (53, 123, 207)),
    (3, 26, (54, 53, 50), (53, 123, 207)),
    (5, 26, (54, 53, 50), (53, 123, 207)),
    (6, 26, (54, 53, 50), (53, 123, 207)),
    (7, 26, (82, 82, 78), (0, 0, 0)),
    (8, 26, (54, 53, 50), (53, 123, 207)),
    (9, 26, (54, 53, 50), (53, 123, 207)),
    (10, 26, (82, 82, 78), (53, 123, 207)),
    (11, 26, (54, 53, 50), (53, 123, 207)),
    (12, 26, (82, 82, 78), (53, 123, 207)),
    (13, 26, (54, 53, 50), (53, 123, 207)),
    (14, 26, (54, 53, 50), (53, 123, 207)),
    (15, 26, (82, 82, 78), (0, 0, 0)),
    (16, 26, (54, 53, 50), (53, 123, 207)),
    (17, 26, (54, 53, 50), (53, 123, 207)),
    (18, 26, (82, 82, 78), (53, 123, 207)),
    (19, 26, (54, 53, 50), (53, 123, 207)),
    (20, 26, (82, 82, 78), (53, 123, 207)),
    # y = 27
    (0, 27, (57, 105, 109), (53, 123, 207)),
    (1, 27, (54, 53, 50), (53, 123, 207)),
    (2, 27, (223, 156, 25), (53, 123, 207)),
    (3, 27, (54, 53, 50), (53, 123, 207)),
    (4, 27, (53, 123, 208), (53, 123, 207)),
    (5, 27, (54, 53, 50), (53, 123, 207)),
    (6, 27, (54, 53, 50), (53, 123, 207)),
    (7, 27, (82, 82, 78), (0, 0, 0)),
    (8, 27, (54, 53, 50), (53, 123, 207)),
    (9, 27, (54, 53, 50), (107, 62, 43)),
    (10, 27, (82, 82, 78), (107, 62, 43)),
    (11, 27, (54, 53, 50), (107, 62, 43)),
    (12, 27, (82, 82, 78), (107, 62, 43)),
    (13, 27, (54, 53, 50), (107, 62, 43)),
    (14, 27, (54, 53, 50), (53, 123, 207)),
    (15, 27, (82, 82, 78), (0, 0, 0)),
    (16, 27, (54, 53, 50), (53, 123, 207)),
    (17, 27, (54, 53, 50), (53, 123, 207)),
    (18, 27, (82, 82, 78), (53, 123, 207)),
    (19, 27, (54, 53, 50), (53, 123, 207)),
    (20, 27, (82, 82, 78), (53, 123, 207)),
    # y = 28
    (0, 28, (54, 53, 50), (53, 123, 207)),
    (1, 28, (54, 53, 50), (53, 123, 207)),
    (2, 28, (54, 53, 50), (53, 123, 207)),
    (3, 28, (244, 243, 240), (53, 123, 207)),
    (4, 28, (244, 243, 240), (53, 123, 207)),
    (5, 28, (244, 243, 240), (53, 123, 207)),
    (6, 28, (244, 243, 240), (53, 123, 207)),
    (7, 28, (244, 243, 240), (0, 0, 0)),
    (8, 28, (244, 243, 240), (53, 123, 207)),
    (9, 28, (244, 243, 240), (53, 123, 207)),
    (10, 28, (244, 243, 240), (76, 67, 60)),
    (11, 28, (54, 53, 50), (53, 123, 207)),
    (12, 28, (244, 243, 240), (76, 67, 60)),
    (13, 28, (244, 243, 240), (53, 123, 207)),
    (14, 28, (244, 243, 240), (53, 123, 207)),
    (15, 28, (244, 243, 240), (0, 0, 0)),
    (16, 28, (244, 243, 240), (53, 123, 207)),
    (17, 28, (244, 243, 240), (53, 123, 207)),
    (18, 28, (244, 243, 240), (53, 123, 207)),
    (19, 28, (54, 53, 50), (53, 123, 207)),
    (20, 28, (244, 243, 240), (53, 123, 207)),
    # y = 29
    (0, 29, (44, 43, 42), (206, 190, 168)),
    (1, 29, (54, 53, 50), (206, 190, 168)),
    (2, 29, (54, 53, 50), (206, 190, 168)),
    (3, 29, (54, 53, 50), (206, 190, 168)),
    (4, 29, (54, 53, 50), (206, 190, 168)),
    (5, 29, (54, 53, 50), (206, 190, 168)),
    (6, 29, (54, 53, 50), (206, 190, 168)),
    (7, 29, (54, 53, 50), (206, 190, 168)),
    (8, 29, (54, 53, 50), (154, 149, 141)),
    (9, 29, (54, 53, 50), (154, 149, 141)),
    (10, 29, (54, 53, 50), (154, 149, 141)),
    (11, 29, (54, 53, 50), (154, 149, 141)),
    (12, 29, (54, 53, 50), (154, 149, 141)),
    (13, 29, (54, 53, 50), (154, 149, 141)),
    (14, 29, (54, 53, 50), (154, 149, 141)),
    (15, 29, (54, 53, 50), (154, 149, 141)),
    (16, 29, (54, 53, 50), (206, 190, 168)),
    (17, 29, (54, 53, 50), (206, 190, 168)),
    (18, 29, (54, 53, 50), (206, 190, 168)),
    (19, 29, (54, 53, 50), (206, 190, 168)),
    (20, 29, (54, 53, 50), (206, 190, 168)),
    # y = 30
...
def fill_cloud_backdrops_transformed(c, transform):
    for x0, y0, x1, y1 in CLOUD_REGIONS:
        for y in range(y0, y1 + 1):
            hline(c, x0, y, x1 - x0 + 1, transform(source_color(0, y)))
...
def draw_train_animation(c, frame, phase, condition):
    ...
    for dx, y, _train_col, stop_col in TRAIN_DIFF_ENTRIES:
        px(c, TRAIN_HOME_X + dx, y, tint(stop_col))

    if visible:
        for dx, y, train_col, _stop_col in TRAIN_DIFF_ENTRIES:
            px(c, TRAIN_HOME_X + dx + x_offset, y, tint(train_col))


def draw_condition_scene(c, frame, condition, phase, clouds, label):
    draw_cmh_for_phase(c, frame, phase, condition, clouds)
    draw_train_animation(c, frame, phase, condition)
