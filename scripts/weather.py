"""
Waterloo, Ontario weather display.

Shows the temperature + condition label in the top-left corner. The rest
of the 64x32 panel is an animated landscape that matches the weather.

On a Raspberry Pi you can replace the WEATHERS demo cycle with a real
fetch (e.g. Open-Meteo for lat=43.4643, lon=-80.5204 — no API key
required) and pass the resulting condition string into draw_scene().
"""
